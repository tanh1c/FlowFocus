...
- <kbd>Space</kbd> : Play / Pause Music
- <kbd>F</kbd> : Toggle Fullscreen
- <kbd>M</kbd> : Open Audio Mixer
- <kbd>T</kbd> : Open Giant Timer
- <kbd>N</kbd> : Open Quick Notes
- <kbd>B</kbd> : Open Task Board
- <kbd>S</kbd> : Open Scene Selector
- <kbd>Z</kbd> : Toggle Zen Mode (Hides all UI elements)
- <kbd>Esc</kbd> : Close active panels
